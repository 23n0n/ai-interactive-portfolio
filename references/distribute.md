...
|---|---|
| 1. One source of truth | `SKILL_INTERACTIVE_PORTFOLIO.md` Non-negotiables #5 ("Content = data, not JSX"); `GUIDE_FROM_SCRATCH.md` Step 8 (Phase C: pages, internal links, sitemap, JSON-LD from the same source); `PLAN_AI_DISTRIBUTION.md` §3 P3 and §11 ("Drift between the contract and the references") |
