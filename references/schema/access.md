...
user-id allowlist** checked next to `is_admin()`. The allowlist is a deny-by-default row set:
...
role edit — does not open the privileged path. Domain restriction is defence in
